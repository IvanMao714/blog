...
import { uploadImageByFile } from "../common/tools";
...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        if(access_token){
            axios.post(import.meta.env.VITE_USER_SERVER_DOMAIN + "user/get-profile", { username: userAuth.username })
            .then(({ data }) => {
                // console.log(data)
                setProfile(data);
                setLoading(false);
    ...
    const handleImageUpload = (e) => {
        ...
        if(updatedProfileImg){
            ...
            .then(url => {
                ...
                if(url){
                    axios.post(import.meta.env.VITE_USER_SERVER_DOMAIN + "user/update-profile-img", { url }, {
                        headers: { 
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(import.meta.env.VITE_USER_SERVER_DOMAIN + "user/update-profile", {
            username, bio, 
